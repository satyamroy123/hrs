...
<head>
    ...
    <title>Disapprove Employee</title>
...
<body>
    ...
    <center>
        ...
        String password;
        String query = String.format("DELETE FROM USER_DETAILS WHERE USERNAME = '%s'", username);
        try {
            ...
            <div id="message" class="success message">
                <%=username%> is not approved as an employee and discarded from the database.
            </div>
            <%
